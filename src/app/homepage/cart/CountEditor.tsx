...
function CountEditor({ quantity, setQuantity, id }: CountEditorProps) {
  ...
  return (
    <div className="py-2 px-2 w-24 border border-[#009999] rounded-md flex flex-row items-center justify-between">
      <button onClick={handleQuantityDecrease}>
        <span className="text-[#009999] text-lg">
          <svg
            width="23"
            height="23"
            viewBox="0 0 23 23"
